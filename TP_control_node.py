...
class TP_controller:
    ...
    def visualize(self, _):
        ...
        # create odom message
        ee_pose = Odometry()
        ee_pose.header.frame_id = 'footprint_new'
    ...
    def publish_static_transform(self):
        ...
        static_transform.header.frame_id = "turtlebot/kobuki/base_footprint"
...
class MobileManipulator:
    ...
    def getEndEffectorPose(self):
        ...
        q3 = self.q[2]
        q4 = self.q[3]
        alpha = -np.pi/2.0      #rotation of the end effector frame with respect to the base frame
        
        # Constants from the manipulator arm drawing 
        self.bx = 0.0132
        self.bz = 0.1080
